...
## 4. You'll see Create An Application. Fill in a name (must be unique) and a brief description (anything OK), and ANY complete website, 
...
## once you read it! (Though in this course we will not be learning concepts 
##	that can violate the TOS...)
